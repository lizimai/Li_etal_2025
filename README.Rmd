...
- exp_processed: this folder stores processed intermediate data produced by scripts
    - updatedAntTable_4before.csv: exploratory behaviour of individual ants from group size 4 during basedline activities
    - updatedAntTable_8before.csv: exploratory behaviour of individual ants from group size 8 during basedline activities
